...
This study focuses on the salt lakes located in the north Sahara, Tunisia, Figure \ref{fig01}. Salt lakes, or sebkhas, of Tunisia present a series of saline depressions that are characterised by variability of water: during the winter, sebkhas receive rare water inflow from occasional rains while during summer months the lakes dry out almost completely and become the saline crystallised surfaces \cite{berthon1970saumures,m2001valorisation,Gautier}. The geographical location of these sebkhas is related to the environmental historical development of north Sahara with related aeolian and fluvial processes \cite{ALI20231,MWIRICHIA2023269}. 
...
First, the images were preprocessed by the 'i.landsat.toar' module of GRASS GIS using properties of image and information on sun elevation level to evaluate the reflectance in pixels and calculation of top-of-atmosphere radiance and temperature for all the Landsat OLI scenes, Figure \ref{fig03}. 
