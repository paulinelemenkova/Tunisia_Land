...
\caption{Classification results showing land cover classes based on the processed Landsat images showing southern study area in the Tunisian Sebkhet en Noual (Sfax Governorate: \textbf{(a)}: 28 February 2017; \textbf{(b)}: 1 April 2017; \textbf{(c)}: 6 July 2017; \textbf{(d)}: 21 February 2023; \textbf{(e)}: 10 April 2023; \textbf{(f)}: 15 July 2023.}\label{fig06}
\end{figure}
