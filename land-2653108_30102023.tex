...
\Author{\hl{Polina} %MDPI: Please carefully check the names and affiliations.
 Lemenkova \orcidA{}}
...
\PACS{\hl{91.10.Da;} %MDPI: Please check if these parts are necessary.
...
\caption{\hl{Two} %MDPI: Please check if the different colored boxes need  explanation.
...
\begin{tabularx}{\textwidth}{CC}
			...
			\midrule
			\multicolumn{2}{c}{\textbf{\hl{Gulf of Hammamet region} %MDPI: Please confirm if the bold should be retained.
}}\\
			\midrule
			\hl{2023/07/15} %MDPI: Please check whether the date format needs to be changed to (Date Month Year), e.g., 1 January 2020.
 & LC91910352023196LGN00 \\	
			...
			\midrule
			\multicolumn{2}{c}{\textbf{\highlighting{Gulf of Gabès region}}}\\
			\midrule
...
\caption{\hl{Landsat images} %MDPI: Figure 3 is not after the first citation, please check and modify.
...
\caption{\hl{Landsat} %MDPI: Figure 4 is not after the first citation, please check and modify.
...
\newblock {\em Rev. Des. Mondes Musulmans  Méditerranée} {\bf 1986},
  {\em 41},~291--326.
\newblock \highlighting{Included in a thematic issue : Désert et montagne au Maghreb.} %MDPI: Please check if this part is necessary, can it be deleted?
...
\newblock {\em Information} {\bf 2023}, {\em 14}, \hl{249.} %MDPI: Please add page number.
...
\newblock Chapter 18 - African salt lakes: Distribution, microbial
  ...
  El-Sheekh, M.; Elsaied, H.E., Eds.; Elsevier:  \hl{Amsterdam, The Netherlands,} % MDPI: Newly added information, please confirm.
 2023; pp. 501--525.
...
\newblock \highlighting{Included in a thematic issue : Télédéctection III.}  %MDPI: Please check if this part is necessary, can it be deleted?
...
\newblock {\em Advanced Remote Sensing. Terrestrial Information Extraction and
  Applications}, 2 ed.; Academic Press:  \hl{Cambridge, MA, USA,} %MDPI: We added the location of publisher. Please confirm.
 2019;
\newblock 1010p.
...
\newblock {\em Remote Sens. Environ.} {\bf 2008}, {\em
  112},~2145--2159.
\newblock \hl{Earth Observations for Terrestrial Biodiversity and Ecosystems
  Special Issue.} %MDPI: Please check if this part is necessary, can it be deleted?
...
\newblock {\em Forests} {\bf 2018}, {\em 9}, \hl{59.}
...
\newblock Chapter 1 - History and formation of African Lakes. In {\em Lakes of
  Africa}; El-Sheekh, M.; Elsaied, H.E., Eds.; Elsevier:  \hl{Amsterdam, The Netherlands,} %MDPI: We added the location of publisher. Please confirm.
 2023; pp. 1--31.
...
\newblock Chapter 9 - Diversity of extremophiles in African brine lakes. In
  {\em Lakes of Africa}; El-Sheekh, M.; Elsaied, H.E., Eds.; Elsevier:  \hl{Amsterdam, The Netherlands,} %MDPI: We added the location of publisher. Please confirm.
  2023;
  pp. 269--287.
...
\newblock \hl{Desalination and the Environment: Fresh Water for All.} %MDPI: Please check if this part is necessary, can it be deleted?
...
\newblock  \hl{35th Year Anniversary Issue. } %MDPI: Please check if this part is necessary, can it be deleted?
...
\newblock {\em Plants} {\bf 2021}, {\em 10}, \hl{2031.}
...
{Food and Agriculture Organization (FAO)}.
  ...
  Online,  2023.
  \hl{Land Use Systems in Tunisia. Monitoring Pilot Programme in Zaghouan
...
\newblock Vulnerability of pastoral ecosystems in northwestern Tunisia to
  climate change.
\newblock {\em Land Degrad. Dev.}, {\em 34}, \hl{4680--4689.}
...
\newblock \hl{Landsat 8 Science Results.} %MDPI: Please check if this part is necessary, can it be deleted?
